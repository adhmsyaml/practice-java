...
Student personID:2020852098
Group:CS1102F
Phone Number:

PROGRAMMER #2
Name:JOHAN ZAFRI BIN JOHAR
Student personID:2020463882
Group:CS1102F
Phone Number:

PROGRAMMER #3
Name:MUHAMMAD NAZRAN ASHRAF BIN MOHD RAZALI
Student personID:2020858726
Group:CS1102F
Phone Number:01128791498

PROGRAMMER #4
Name:TENGKU AKMAL HAZIQ BIN TENGKU AMRAN
Student personID:2020888038
Group:CS1102F
Phone Number:
...
public class VBSApp {
    public static void main(String args[]) {
        ...
        for (int i = 0; nextBooking.equalsIgnoreCase("y") && i < 20; i++) {
            ...
            customer[i] = new PersonInCharge(personName, personID, personAddress, personContactNumber,
                    new Event(eventName, venue, eventDate, eventStartTime, eventEndTime, new Booking(" "), 0));
